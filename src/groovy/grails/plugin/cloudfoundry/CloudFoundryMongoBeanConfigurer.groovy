 ...
 */
class CloudFoundryMongoBeanConfigurer extends AbstractMongoBeanConfigurer {

	@Override
	protected Map findMongoValues(GrailsApplication application) {

		MongoServiceInfo serviceInfo = new AppCloudEnvironment().getServiceByVendor('mongodb')
		if (!serviceInfo) {
			return null
		}

		[databaseName: serviceInfo.db,
